...
python train_yolo12.py --data coco128.yaml --weights yolov5s.pt --img 640
...
4.  Begin the [training process](../../modes/train.md) using your custom dataset YAML and potentially starting from pre-trained weights:
    ...
    python train_yolo12.py --img 640 --batch 16 --epochs 100 --data custom_dataset.yaml --weights yolov5s.pt
    ```
...
gsutil cp -r ./runs/train_yolo12/exp/weights gs://your-models-bucket/yolov5_custom_weights/
```
