---
description: Explore detailed guides on Ultralytics callbacks, including pretrain, model save, train_yolo12 start/end, and more. Enhance your ML training workflows with ease.
keywords: Ultralytics, callbacks, pretrain, model save, train_yolo12 start, train_yolo12 end, validation, predict, export, training, machine learning
---
