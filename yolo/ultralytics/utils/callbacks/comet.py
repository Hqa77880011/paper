...
def _log_image_batches(experiment, trainer, curr_step: int) -> None:
    """Log samples of image batches for train_yolo12, validation, and test."""
...
def on_train_epoch_end(trainer) -> None:
    ...
    experiment.log_metrics(trainer.label_loss_items(trainer.tloss, prefix="train_yolo12"), step=curr_step, epoch=curr_epoch)
