...
class RF100Benchmark:
    ...
    Methods:
        ...
        fix_yaml: Fix train_yolo12 and validation paths in YAML files.
    ...
    def fix_yaml(path: Path):
        """Fix the train_yolo12 and validation paths in a given YAML file."""
        yaml_data = YAML.load(path)
        yaml_data["train_yolo12"] = "train_yolo12/images"
