...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Attributes:
        ...
        data (dict): Final processed data configuration containing train_yolo12/val paths and metadata.
    ...
    Methods:
        ...
        get_dataset: Get train_yolo12 and validation paths from data dictionary.
    ...
    Examples:
        ...
        >>> model.train_yolo12(data=data, trainer=WorldTrainerFromScratch)
    """
    ...
    def build_dataset(self, img_path, mode="train_yolo12", batch=None):
        ...
        Args:
            ...
            mode (str): 'train_yolo12' mode or 'val' mode, allowing customized augmentations for each mode.
    ...
    def get_dataset(self):
        """
        Get train_yolo12 and validation paths from data dictionary.
        ...
        Raises:
            AssertionError: If train_yolo12 or validation datasets are not found, or if validation has multiple datasets.
        """
        final_data = {}
        data_yaml = self.args.data
        assert data_yaml.get("train_yolo12", False), "train_yolo12 dataset not found"  # object365.yaml
        ...
        for s in ["train_yolo12", "val"]:
            final_data[s] = [d["train_yolo12" if s == "train_yolo12" else val_split] for d in data[s]]
        ...
        if self.args.single_cls:  # consistent with base trainer
            ...
            self.data["nc"] = 1
        self.training_data = {}
        for d in data["train_yolo12"]:
            if self.args.single_cls:
                d["names"] = {0: "object"}
                d["nc"] = 1
            self.training_data[d["train_yolo12"]] = d
        return final_data
